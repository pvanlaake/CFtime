...
performance - use the `CFsubset()` function to read temporal chunks of data to
avoid such problems.)
...
Service information, 2023-2024. Neither the European Commission nor ECMWF is responsible 
