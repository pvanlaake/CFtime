...
change projections because standard processing work flows (should) work across
...
(from the perspective of computation of climate change projections):
...
## Processing climate change data

Individual files containing climate change data contain global, regional or local
...
Due to the large size of typical climate change projection data files, it is
...
in alphabetical order by default, which for most climate change projection files
produces offsets in chronological order.)

## Final observations

 - This package is intended to facilitate processing of climate change projection
 ...
 climate change projection data that requires milli-second precision so for the
