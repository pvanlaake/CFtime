...
dimension of the file. Theprocess then becomes as follows, for a CMIP6 file of 
daily precipitation:
...
31 January is missing from the vector of `Date`s becasue the `360_day` calendar 
