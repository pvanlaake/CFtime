...
introduced. From its introduction in 1962 until the end of 1971 the UTC clock
used a "second" that was slightly faster than the SI second, as well as periodic
jumps of 50 to 300 ms to synchronize the clock with the Earth's rotation around
the Sun. At the end of 1971 the difference between TAI and UTC was set to 
exactly 10 seconds (SI) and 27 leap seconds have been added since (for a total
difference of 37 seconds, but **not 37 leap seconds** as the conventions state).
Leap seconds are always accounted so when a leap second is included, UTC time 
progresses like `23:59:58 ... 23:59:59 ... 23:59:60 ... 00:00:00 ... 00:00:01`.
