...
class operates on the data in the file of interest, here a CORDEX file of
...
precipitation in the Central America domain using Coordinated Regional Climate 
Downscaling Experiment (CORDEX) data, you can calculate
